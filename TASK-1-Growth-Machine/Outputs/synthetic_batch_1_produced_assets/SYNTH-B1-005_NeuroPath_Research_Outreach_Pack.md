# Milestone Intelligence & Proposal Outreach Pack
**Recipient**: Chief Scientific Officer, NeuroPath Research  
**Trigger Milestone**: Public Publication / Award of *DARPA Sub-Tier Collaborative Milestone Report*  
**Research Stack**: Spike-sorting transformer on FPGA | Target Metric: Closed-loop motor decoding latency < 5ms | Scope: $2,800,000  

---

## 1. Personalized Outbound Email (Respectful & Non-Intrusive)

**Subject**: DARPA Sub-Tier Collaborative Milestone Report & multi-author proposal drafting  
**To**: Chief Scientific Officer at NeuroPath Research

```text
Hi there,

Congratulations to the team at NeuroPath Research on the recent milestone with "DARPA Sub-Tier Collaborative Milestone Report"! Tracking your work on Spike-sorting transformer on FPGA has been really impressive.
...
👉 https://use.superdocs.app/sandbox/neuropath-research-proposal-kit
...
|---|---|---|---|
| **Section 2 / Executive Abstract** | Target Metric: `Closed-loop motor decoding latency < 5ms` | Section 5 Milestones | Synchronized in-document update |
| **Section 3.2 / Architecture Spec** | Architecture: `Spike-sorting transformer on FPGA` | Section 7 Compute Allocation | Synchronized budget table refactor |
